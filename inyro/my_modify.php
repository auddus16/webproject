          ...
          <form action="./my_modify_update.php"name="memInfor" method="post">
              <div class="formInfor">
                ...
                <input type="text" name="mb_major" value="<?php echo $mb['mb_major'] ?>"style="width:500px; height:35px; margin-bottom:15px;" disabled><br>
                  ...
                  <input class="mybt" type="button" name="modify" value="수정" onclick="location.href='myongyeon8_modify.html'" style="width:100px; height:30px; margin-right:10px">
                  <input class="mybt" type="button" name="withdraw" value="탈퇴" onclick="location.href='myongyeon8_withdraw.html'" style="width:100px; height:30px; margin-left:10px">
                </div>
              </div>
          </form>
        </div>
